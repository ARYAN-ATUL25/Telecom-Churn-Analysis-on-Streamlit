...
![](https://img.shields.io/github/forks/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit.svg)
![](https://img.shields.io/github/stars/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit.svg)
![](https://img.shields.io/github/issues/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit.svg)
![](https://img.shields.io/github/last-commit/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit.svg)
  
 
 <h4>
  <span> · </span>
    <a href="https://github.com/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit/blob/master/README.md">Documentation</a>
  <span> · </span>
    <a href="https://github.com/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit/issues">Report Bug</a>
  <span> · </span>
    <a href="https://github.com/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit/issues">Request Feature</a>
  </h4>
</div>
...
```bash
git clone https://github.com/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit.git
```
...
This tool has been deployed using [`Streamlit`](https://streamlit.io/). Learn about streamlit deployment [`here`](https://docs.streamlit.io/streamlit-community-cloud/get-started/deploy-an-app). Checkout the notebook repository [`here`](https://github.com/ARYAN-ATUL25/Telecom-Churn-Analysis-on-Streamlit) from where the pickle file has been imployed in the tool.
